...
const pressImages: PressImage[] = [
  {
    id: "portrait-studio",
    src: "/press/portrait-studio.jpg",
    alt: "Portrait of P. K. Yorke in a studio space, surrounded by equipment and percussion instruments.",
    title: "Portrait, studio",
    context: "Studio portrait of P. K. Yorke, 2025.",
    credit: "Photo: Photographer Name",
    orientation: "portrait",
    downloadHref: "/press/portrait-studio-full.jpg",
  },
  {
    id: "performance-stage",
    src: "/press/performance-stage.jpg",
    alt: "P. K. Yorke performing a work for percussion and electronics on stage.",
    title: "Performance",
    context: "Performance still from a work for percussion and electronics.",
    credit: "Photo: Photographer Name",
    orientation: "landscape",
    downloadHref: "/press/performance-stage-full.jpg",
  },
  {
    id: "installation-view",
    src: "/press/installation-view.jpg",
    alt: "Installation view with loudspeakers and sculptural elements lit in low light.",
    title: "Installation view",
    context: "Installation view of a sound work for loudspeakers and light.",
    credit: "Photo: Photographer Name",
    orientation: "landscape",
    downloadHref: "/press/installation-view-full.jpg",
  },
];
